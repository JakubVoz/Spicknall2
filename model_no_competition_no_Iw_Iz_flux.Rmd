---
title: "model_no_competition_no_Iw_Iz_flux"
author: "Jakub"
date: "11 ledna 2017"
...
SIS=function(times, state, parameters){
  with(as.list(c(state,parameters)),
       { dnewcasesIz=beta_z*Iz*S + eps*beta_z*Iz*Iw
...
parameters3 <- c(beta_w=pbeta_w, beta_z=pbeta_z, gamma=pgammaa, gamma_prim=pgamma_tilt, eps=peps)
...
plot(t2, NewIw[,11], main="Incidence of susceptible infections after a change in epsilon \n no interhost competition no Iw Iz fluxes no Iz Iw fluxes", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_zoom[,11], main="Dynamics \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, NewIz[,11], main="Incidence of resitant infections after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,11], main="Dynamics \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,11], main="Dynamics \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, Newp[,11], main="Estimated p after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Realp[,11], main="Estimated real p after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,11], main="Flow : infection of susceptibles after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of resistant cases after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive cases after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_Iz[,11], main="Flow : gaining resistance in sensitive cases after a change in epsilon \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(epsvar, Clear, xlab=expression(epsilon), ylab="Proportion flow", main = "Clearance \n no interhost competition no Iw Iz fluxes", type="l", col="green", lwd=2, ylim=c(0,0.012))
...
plot(t2, new_cases[,11], main="Global incidence : dynamics \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,11], main="Global incidence : zoom \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0.0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_S[,11], main="Net flow : Iw to S \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw to S", ylim=c(-0.004,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,11], main="Net flow : S to Iz \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iz to S", ylim=c(-0.004, 0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,11], main="Net flow : S to Iz \n no interhost competition no Iw Iz fluxes", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.004,0.004), lty=1, lwd=2, type="l")
...
plot(epsico_ext, fatality, main="Fatality \n no interhost competition no Iw Iz fluxes", xlab=expression(epsilon), ylab="fatality, ratio", lty=1, lwd=2, type="l", col="green", ylim=c(0,0.1))
