...
Based on literature, the proportion of treatment failures is between 4 and 8% (add a quote) for tuberculosis. It has a significant impact on the proportion of $I_w$ and $I_z$. When it increases the prevalence of $I_z$ increases at the expense of $I_w$, while the global burden of the disease decreases.
...
knitr::include_graphics("./AMU_var_incidence_files/figure-html/ss_p_prevalence-1.png")
```
