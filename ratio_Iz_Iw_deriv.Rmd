...
\frac{dp}{dt} &= pS(\beta_z-\beta_w)+p\varepsilon(\gamma '-\gamma)+(1+p) \left( c_{wz}(1-\varepsilon)+\varepsilon \right) \beta_zI_z+\rho\varepsilon(1+p)-(1+p)c_{zw}(1-\varepsilon)\beta_wI_z
