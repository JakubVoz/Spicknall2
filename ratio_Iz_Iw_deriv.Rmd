...
dp <- incid(out$Iz_div_Inf)

dq <- incid(out$Iz_plus_Iw)

```

```{r incid_plot, include=FALSE}

plot(times, dp, xlab = "time (steps)", ylab = "dp", main = "Evolution dp over time")

plot(times, dq, xlab = "time (steps)", ylab = "dq", main = "Incidence")
