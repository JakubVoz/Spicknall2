...
<center> <h3> Steady states when varying AMU </h3> </center>
...
This means that at steady states, with nearly the same quantity of antibiotics (0.055 and 0.06) nearly a double proportion of patients can be treated (10% and 17%).
...
b) saturation part of the curve of AMU=f(PTP) ([0.055, 0.06] of AMU corresponds to [10%,17%] of PTP)
...
When relating p and AMU, the proportion of resistant cases among new cases increases very steeply at higher values (0.055 ti 0.060) of AMU. This is once again due to:

a) relatively steep increase in p=f(PTP)
