...
\frac{dI_z}{dt} &={\beta_z} {I_z}{S} + ({c_{wz}}(1-{\epsilon}) + \epsilon) {\beta_z}{I_z}{I_w} + {\rho}{\epsilon}{I_W} - {\gamma}  {I_z} - {c_{zw}}(1-{\epsilon})\beta_w{I_w}{I_z} \\
...
\frac{dp}{dt} = {p}{S}({\beta_z}-{\beta_w})+{p}{\epsilon}({\gamma `}-{\gamma}) + (1+{p})({c_{wz}}(1-\epsilon)+{\epsilon}){\beta_z}{I_z}+{\rho}{\epsilon}({1+{p}})-(1+{p}){c_{zw}}(1-{\epsilon}){\beta_w}{I_z}
\end{aligned}
