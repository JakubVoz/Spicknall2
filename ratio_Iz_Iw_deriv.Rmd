...
This resistance is represented in our model as a flow from $I_w$ to $I_z$ depending on the AMU and probability of acquiring resistance when treated.
...
<center> <h3> Dynamics of S to Iw flow after a change in AMU</h3> </center>
