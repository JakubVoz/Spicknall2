...
$$
\begin{aligned}
\frac{\frac {dI_z}{dM}}{dt} &= -\beta_zI_z(1-\varepsilon) + \varepsilon\beta_wI_z + \frac{1}{M} \left( \beta_z I_z^{2}(1-\varepsilon) + I_z(\beta_z-\beta_w) - I_z^{2}\beta_w\varepsilon + I_z\varepsilon(\gamma` - \gamma) \right) + \frac{1}{M^{2}} \left(I_z^{2}(\beta_w-\beta_z)+I_z^{2}\varepsilon(\gamma-\gamma`) \right)+ \frac{M-I_z}{M}\rho\varepsilon \\
\end{aligned}
$$
Where:
$$
