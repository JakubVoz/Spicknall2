...
plot(pepsi_change, time_up, main="Inertia", xlab=expression(epsilon), ylab="time to stabilization", lwd=2, col='red', type='l', xlim=c(0,0.14))
lines(pepsi_change, time_down, lwd=2, col='blue', type='l')
...
plot(epsx1, diff_1, main="Inertia : difference between decreasing \n and increasing epsilon", xlab=expression(epsilon), ylab="delta t", lwd=2, col='red', type='l', xlim=c(0,0.14))
...
plot(epsx2, diff_2_same_metrics, main="Inertia : comparison of differences between decreasing \n and increasing epsilon", xlab=expression(epsilon), ylab="delta t/ delta eps", lwd=2, col='blue', type='l', xlim=c(0,0.14))
