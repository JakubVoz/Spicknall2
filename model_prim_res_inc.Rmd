...
parameters3 <- c(beta_w=pbeta_w, beta_z=pbeta_z, gamma=pgammaa, gamma_prim=pgamma_tilt, eps=peps, rho=prho2)


times3=seq(a, a+zoom_area, by=m/zoom)


#pb : a point stable Iz=0.00000
...
state3 <- c(S=1-2*prop, Iw=prop, Iz=prop, dnewcasesIz=0, dnewcasesIw=0, dsecondaryres=0, dprimaryres=0, newS_to_Iw=0, Iz_to_Iw=0, Iw_to_S=0, Iw_to_Iz=0, newS_to_Iz=0, Iz_to_S=0)
...
plot(t2, NewIw[,2], main="Incidence of susceptible infections \n after a change in PTP", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")

capture.output(apply(NewIw, 2, linfun, t2),file='NUL') 

legend("bottomleft" , inset=.05, c("PTP=0.20", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))

#zoom

plot(time_zoom, Iw_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iw_ss, xlab="PTP", ylab="Iw incidence", main = "Impact of PTP on steady state Iw incidence", type="l")
```
...
plot(t2, NewIz[,2], main="Incidence of resitant infections \n after a change in PTP", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")

capture.output(apply(NewIz, 2, linfun, t2), file='NUL')

legend("topleft" , inset=.05, c("PTP=0.20", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))

#zoom

plot(time_zoom, Iz_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_ss, xlab="PTP", ylab="Iz incidence", main = "Impact of PTP on steady state Iz incidence", type="l")
...
plot(t2, Newprim[,2], main="Incidence of primary resistance \n after a change in PTP", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, prim_ss, xlab="PTP", ylab="Primary resistance incidence", main = "Impact of PTP on steady state primary resistance incidence", type="l")
```
...
plot(t2, Newsec[,2], main="Incidence of secondary resistance \n after a change in PTP", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")

capture.output(apply(Newsec, 2, linfun, t2), file='NUL')

legend("topright" , inset=.05, c("PTP=0.20", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))

#zoom

plot(time_zoom, sec_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, sec_ss, xlab="PTP", ylab="Secondary resistance incidence", main = "Impact of PTP on steady state secondary resistance incidence", type="l")
```
...
plot(t2, Newp[,2], main="Estimated p after a change in PTP", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(time_zoom, p_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, p_ss, xlab="PTP", ylab="p", main = "Impact of PTP on steady state p", type="l")
```
...
plot(t2, Realp[,2], main="Estimated real p after a change in PTP", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(time_zoom, realp_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, realp_ss, xlab="PTP", ylab="real p", main = "Evolution of p ratio- incidence", type="l", lwd=2)
```

```{r S_to_Iw_flow, echo=FALSE, fig.align='center'}
par(mfrow=c(1,2))

plot(t2, NewS_to_Iw[,2], main="Flow : infection of susceptibles \n after a change in PTP", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iw_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, S_to_Iw_ss, xlab="PTP", ylab="S to Iw flow", main = "Impact of PTP on steady state S to Iw flow", type="l")
...
plot(t2, NewS_to_Iz[,2], main="Flow : infection of susceptibles \n after a change in PTP", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iz_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, S_to_Iz_ss, xlab="PTP", ylab="S to Iz flow", main = "Impact of PTP on steady state S to Iz flow", type="l", lwd=2)
...
plot(t2, NewIz_to_Iw[,2], main="Flow : infection and conversion of \n resistant cases after a change in PTP", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_to_Iw_ss, xlab="PTP", ylab="Iz to Iw flow", main = "Impact of PTP on steady state Iz to Iw flow", ylim=c(0,0.003), type="l")
...
plot(t2, NewIw_to_S[,2], main="Flow : clearance of sensitive \n cases after a change in PTP", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_S_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iw_to_S_ss, xlab="PTP", ylab="Iw to S flow", main = "Impact of PTP on steady state Iw to S flow", ylim=c(0,0.01), type="l")
...
plot(t2, NewIw_to_Iz[,2], main="Flow : gaining resistance in sensitive \n cases after a change in PTP", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_Iz_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iw_to_Iz_ss, xlab="PTP", ylab="Iw to Iz flow", main = "Impact of PTP on steady state Iw to Iz flow", type="l")
...
plot(epsvar, S_to_Iw_ss, xlab="PTP", ylab="Iw to Iz flow", main = "Comparing strength and evolution \n of different flows related to Iw", type="l", lty=1, col="green", lwd=2)
...
plot(epsvar, Iz_ss, xlab="PTP", ylab="Incidence", main = "Incidence of resistant cases", type="l", lwd=2)
...
plot(epsvar, Iw_ss, xlab="PTP", ylab="Incidence", main = "Resistant vs sensitive incidence", type="l", col="green", lwd=2)
...
plot(epsvar, Iwz_ss, xlab="PTP", ylab="Proportion flow", main = "Incidence", type="l", col="red", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, Clear, xlab="PTP", ylab="Proportion flow", main = "Clearance", type="l", col="green", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, recov_ss, xlab="PTP", ylab="proportion change", main = "Comparing strength and evolution \n of different flows related to Infection", type="l", lty=1, col="green", lwd=2, ylim=c(0, 0.01))
...
plot(epsvar, S_var_ss, xlab="PTP", ylab="Steady state var", main = "Evolution of state variables \n at steady-state", type="l", lty=1, lwd=2, ylim=c(0, 1))
...
plot(epsvar, prodSIw_ss, xlab="PTP", ylab="Mass product", main = "Evolution of mass product at steady state", type="l", lty=3, lwd=2, ylim=c(0, 0.25))
...
plot(epsvar, p_prevalence_ss, xlab="PTP", ylab="p", main = "Evolution of p ratio - prevalence", type="l", lty=1, lwd=2, ylim=c(0, 1))
...
plot(epsvar, burden, xlab="PTP", ylab="Iw+Iz", main = "Steady-state burden of infection", type="l", lty=1, lwd=2, ylim=c(0, 1))
...
plot(t2, new_cases[,2], main="Global incidence : dynamics", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,2], main="Global incidence : zoom", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0.0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_Iz_zoom[,2], main="Dynamics Iw to Iz", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,2], main="Dynamics Iz to Iw", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_S[,2], main="Net flow : Iw to S", xlab="time (steps)", ylab="Iw to S", ylim=c(-0.003,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,2], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iz to S", ylim=c(0, 0.001), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,2], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.002,0.003), lty=1, lwd=2, type="l")
