...
plot(t2, NewIw[,2], main="Incidence of susceptible infections \n no secondary resistance", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, NewIz[,2], main="Incidence of resitant infections \n after a change in epsilon \n no secondary resistance", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,2], main="Incidence of primary resistance \n no secondary resistance", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,2], main="Dynamics", xlab="time (steps)", ylab="Incidence primary resistace \n no secondary resistance", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,2], main="Incidence of secondary resistance  \n no secondary resistance", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(t2, Newp[,2], main="Estimated p after a change in epsilon \n no secondary resistance", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(time_zoom, p_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Realp[,2], main="Estimated real p after a change in epsilon \n no secondary resistance", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(time_zoom, realp_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iw_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,2], main="Flow : infection of susceptibles \n no secondary resistance", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iz_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,2], main="Flow : infection and conversion of resistant cases \n no secondary resistance", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_S[,2], main="Flow : clearance of sensitive \n no secondary resistance", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_S_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_Iz[,2], main="Flow : gaining resistance in sensitive \n no secondary resistance", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_Iz_zoom[,2], main="Dynamics \n no secondary resistance", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, new_cases[,2], main="Global incidence : dynamics \n no secondary resistance", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,2], main="Global incidence : zoom \n no secondary resistance", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0.0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_Iz_zoom[,2], main="Dynamics Iw to Iz \n no secondary resistance", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,2], main="Dynamics Iz to Iw \n no secondary resistance", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_S[,2], main="Net flow : Iw to S \n no secondary resistance", xlab="time (steps)", ylab="Iw to S", ylim=c(-0.003,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,2], main="Net flow : S to Iz \n no secondary resistance", xlab="time (steps)", ylab="Iz to S", ylim=c(0, 0.001), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,2], main="Net flow : S to Iz \n no secondary resistance", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.002,0.003), lty=1, lwd=2, type="l")
