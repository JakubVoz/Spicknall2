...
plot(t2, Newp[,2], main="Estimated p after a change in epsilon", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, p_ss, xlab=expression(epsilon), ylab="p", main = "Impact of epsilon on steady state p", type="l")
```
...
plot(t2, Realp[,2], main="Estimated real p after a change in epsilon", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, realp_ss, xlab=expression(epsilon), ylab="real p", main = "Evolution of p ratio- incidence", type="l", lwd=2)
```
...
plot(t2, NewIw_to_S[,2], main="Flow : clearance of sensitive \n cases after a change in epsilon", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(epsvar, Iwz_ss, xlab=expression(epsilon), ylab="Proportion flow", main = "Incidence", type="l", col="red", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, recov_ss, xlab=expression(epsilon), ylab="proportion change", main = "Comparing strength and evolution \n of different flows related to Infection", type="l", lty=1, col="green", lwd=2, ylim=c(0, 0.01))
