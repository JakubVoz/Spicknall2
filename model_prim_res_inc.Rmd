...
plot(t2, Newp[,2], main="Estimated p after a change in AMU", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Realp[,2], main="Estimated real p after a change in AMU", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, realp_ss, xlab="AMU", ylab="real p", main = "Evolution of p ratio- incidence", type="l", lwd=2)
```
...
par(mfrow=c(1,1))
plot(epsvar, S_to_Iz_ss, xlab="AMU", ylab="S to Iz flow", main = "Impact of AMU on steady state S to Iz flow", type="l", lwd=2)
...
plot(t2, NewIw_to_S[,2], main="Flow : clearance of sensitive \n cases after a change in AMU", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(epsvar, Iwz_ss, xlab="AMU", ylab="Proportion flow", main = "Incidence", type="l", col="red", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, Clear, xlab="AMU", ylab="Proportion flow", main = "Clearance", type="l", col="green", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, p_prevalence_ss, xlab="AMU", ylab="p", main = "Evolution of p ratio - prevalence", type="l", lty=1, lwd=2, ylim=c(0, 1))
...
plot(epsvar, burden, xlab="AMU", ylab="Iw+Iz", main = "Steady-state burden of infection", type="l", lty=1, lwd=2, ylim=c(0, 1))
