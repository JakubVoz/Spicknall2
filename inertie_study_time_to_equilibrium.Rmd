...
plot(pepsi_change, time_up, main="Inertia - delta epsilon = 0.01", xlab="proportion of treated patients", ylab="time to stabilization", lwd=2, col='red', type='l', xlim=c(0,0.20))
...
plot(pepsi_change, time_up, main="Inertia", xlab="proportion of treated patients", ylab="time to stabilization", lwd=2, col='red', type='l', xlim=c(0,0.20))
lines(pepsi_change, time_down, lwd=2, col='blue', type='l')
...
plot(epsx1, diff_1_same_metrics, main="Inertia : difference between increasing \n and decreasing epsilon", xlab="proportion of treated patients", ylab="delta t/ delta eps", lwd=2, col='red', type='l', xlim=c(0,0.17))
lines(epsx2, diff_2_same_metrics, lwd=2, col='blue', type='l')
abline(h=0, col='black')
