...
plot(t2, NewIz[,11], main="Incidence of resitant infections \n after a change in epsilon", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance \n after a change in epsilon", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance \n after a change in epsilon", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,11], main="Flow : infection of susceptibles \n after a change in epsilon", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.05), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of \n resistant cases after a change in epsilon", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.03), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_to_Iw_ss, xlab=expression(epsilon), ylab="Iz to Iw flow", main = "Impact of epsilon on steady state Iz to Iw flow", ylim=c(0,0.005), type="l")
