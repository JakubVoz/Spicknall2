...
plot(t2, NewIz[,11], main="Incidence of resitant infections after a change in epsilon \n no interhost competition", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance after a change in epsilon \n no interhost competition", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,11], main="Dynamics \n no interhost competition", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance after a change in epsilon \n no interhost competition", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,11], main="Dynamics \n no interhost competition", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,11], main="Flow : infection of susceptibles after a change in epsilon \n no interhost competition", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.05), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive cases after a change in epsilon \n no interhost competition", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,11], main="Dynamics Iz to Iw \n no interhost competition", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.003), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_S[,11], main="Net flow : Iw to S \n no interhost competition", xlab="time (steps)", ylab="Iw to S", ylim=c(-0.003,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,11], main="Net flow : S to Iz \n no interhost competition", xlab="time (steps)", ylab="Iz to S", ylim=c(0, 0.001), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,11], main="Net flow : S to Iz \n no interhost competition", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.002,0.003), lty=1, lwd=2, type="l")
