---
title: "model_no_competition_inc"
author: "Jakub"
...
plot(t2, NewIz[,11], main="Incidence of resitant infections \n after a change in PTP", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance \n after a change in PTP", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance \n after a change in PTP", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.04), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,11], main="Flow : infection of susceptibles \n after a change in PTP", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.05), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iz_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.05), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of \n resistant cases after a change in PTP", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.03), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.03), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_to_Iw_ss, xlab="PTP", ylab="Iz to Iw flow", main = "Impact of PTP on steady state Iz to Iw flow", ylim=c(0,0.005), type="l")
...
plot(time_zoom, Iw_to_S_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,11], main="Global incidence : zoom", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0.0,0.01), lty=1, lwd=2, type="l")
