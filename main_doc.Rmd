...
###Comparing TREs for the same end value of $varepsilon$
...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("./inertie_study_time_to_equilibrium_start2_files/figure-html/time_to_stabilization_plot-1.png")
```

####Difference between TREs : Delay
...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("./inertie_study_time_to_equilibrium_start2_files/figure-html/plot_dif-1.png")
```

####Delay with same metrics
...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("./inertie_study_time_to_equilibrium_start2_files/figure-html/plot_same_metrics-1.png")
```
