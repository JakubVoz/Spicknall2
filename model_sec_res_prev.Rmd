...
pepsi <- seq(0,1,by=0.02) #variation of epsilon
...
plot(t2, S_der[,11], main="Derivative of Susceptible population after a variation of  AMU", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(t3, S_der_zoom[,11], main="Derivative of Susceptible population after a variation of  AMU", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(t2, Iw_der[,11], main="Derivative of population infected with sensitive strain after a variation of  AMU", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(t3, Iw_der_zoom[,11], main="Derivative of population infected with sensitive strain after a variation of  AMU", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
#plotting Iz
plot(t, Iz[,11], main="Evolution of population infected with resistant strain after a variation of  AMU", xlab="time (steps)", ylab="Iz ratio", ylim=c(0,0.2), lty=1, lwd=2, type="l")
...
plot(t2, Iz_der[,11], main="Derivative of population infected with resistant strain after a variation of  AMU", xlab="time (steps)", ylab="Iz ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
#plotting zoomed Iw derivative with respect to time
plot(t3, Iz_der_zoom[,11], main="Derivative of population infected with resistant strain after a variation of  AMU", xlab="time (steps)", ylab="Iz ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(epsvar, p_steady, main="Evolution of p ratio - prevalence", xlab="AMU", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t, prod_S_Iw[,11], main="Evolution of S*Iw after a change in AMU", xlab="time (steps)", ylab="S*Iw", ylim=c(0,0.25), lty=1, lwd=2, type="l")
...
plot(t, prod_S_Iz[,11], main="Evolution of S*Iz after a change in AMU", xlab="time (steps)", ylab="S*Iz", ylim=c(0,0.15), lty=1, lwd=2, type="l")
...
plot(t, prod_Iw_Iz[,11], main="Evolution of Iw*Iz after a change in AMU", xlab="time (steps)", ylab="Iw*Iz", ylim=c(0,0.05), lty=1, lwd=2, type="l")
