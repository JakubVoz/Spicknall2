...
plot(t2, S_der[,11], main="Derivative of Susceptible population after a variation of  AMU", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.010), lty=1, lwd=2, type="l")
...
plot(t3, S_der_zoom[,11], main="Derivative of Susceptible population after a variation of  AMU", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.010), lty=1, lwd=2, type="l")
...
plot(t2, Iw_der[,11], main="Derivative of population infected with sensitive strain after a variation of  AMU", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.010,0.010), lty=1, lwd=2, type="l")
...
plot(t3, Iw_der_zoom[,11], main="Derivative of population infected with sensitive strain after a variation of  AMU", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.010,0.010), lty=1, lwd=2, type="l")
