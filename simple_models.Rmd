...
plot(t2, NewIw[,11], main="Incidence of susceptible infections \n after a change in AMU", xlab="time (steps)", ylab="Incidence Iw", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence Iw", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
