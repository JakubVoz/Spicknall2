...
__Plot n°1 Single-strain model__: $\beta$ ~w~ = 0.0001, $\beta$ ~z~ = 0.00005, $\gamma$ = 0.005, $\gamma$?= 0.5 and $\epsilon$ = 0.7  are the chosen values of parameters. The $\delta$t = 1/12 year i.e. 1 month and we follow the evolution of population infected with sensitive strain (_dotted line_), with resistant strain (_dashed line_) and with both (_dashed-dotted line_) over 30 years.
...
__Plot n°2 Superinfection model__: $\beta$ ~w~ = 0.0001, $\beta$ ~z~ = 0.00005, $\gamma$ = 0.005, $\gamma$?= 0.5 and $\epsilon$ = 0.7 and $q$ = 0.25  are the chosen values of parameters. The $\delta$t = 1/12 year i.e. 1 month and we follow the evolution of the sensitive subpopulation (_solid line_), the subpopulation infected with sensitive strain exclusively (_dotted line_), with resistant strain exclusively (_dashed line_) and with both (_dashed-dotted line_) over 30 years.
...
__Plot n°4 Replacement infection model__: $\beta$ ~w~ = 0.0001, $\beta$ ~z~ = 0.00005, $\gamma$ = 0.005, $\gamma$?= 0.5 and $\epsilon$ = 0.7  are the chosen values of parameters. The $\delta$t = 1/12 year i.e. 1 month and we follow its evolution during 30 years. The $\delta$t = 1/12 year i.e. 1 month and we follow the evolution of the sensitive subpopulation (_solid line_), the subpopulation infected with sensitive strain exclusively (_dotted line_) and with resistant strain exclusively (_dashed line_) over 30 years.
