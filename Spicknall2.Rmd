...
plot(times, out_super$S/N, main="Plot n°2 - Superinfection model", xlab="time (yrs)", ylab="ratio", ylim=c(0,1), lty=2, lwd=2, type="l")
...
plot(times, out_exc$S/N, main="Plot n°3 - Exclusive infection model", xlab="time (yrs)", ylab="ratio", ylim=c(0,1), lty=2, lwd=2, type="l")
...
plot(times, out_uni$S/N, main="Plot n°5 - Unidirectional conversion model", xlab="time (yrs)", ylab="ratio", ylim=c(0,1), lty=2, lwd=2, type="l")
...
plot(times, out_bi$S/N, main="Plot n°6", xlab="time (yrs)", ylab="ratio", ylim=c(0,1), lty=2, lwd=2, type="l")
