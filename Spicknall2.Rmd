...
plot(times, out$Iw/N, main="Plot n°1 - Single-strain model", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=3, lwd=2, type="l")
...
plot(times, out_super$S/N, main="Plot n°2 - Superinfection model", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(times, out_exc$S/N, main="Plot n°3 - Exclusive infection model", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(times, out_rep$S/N, main="Plot n°4 - Replacement infection model", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(times, out_uni$S/N, main="Plot n°5 - Unidirectional conversion model", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(times, out_bi$S/N, main="Plot n°6", xlab="time (steps)", ylab="ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
