...
__Plot n°1 Single-strain model__: $\beta$ ~w~ = 0.0001, $\beta$ ~z~ = 0.00005, $\gamma$ = 0.005, $\gamma$?= 0.5 and $\epsilon$ = 0.7  are the chosen values of parameters. The $\delta$t = 1/12 year i.e. 1 month and we follow the evolution of population infected with sensitive strain (_dotted line_) and with resistant strain (_dashed line_) over 30 years.
