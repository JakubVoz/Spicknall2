...
plot(t, prod_S_Iw[,11], main="Evolution of S*Iw after a change in AMU", xlab="time (steps)", ylab="S*Iw", ylim=c(0,0.3), lty=1, lwd=2, type="l")
...
plot(t, prod_S_Iz[,11], main="Evolution of S*Iz after a change in AMU", xlab="time (steps)", ylab="S*Iz", ylim=c(0,0.3), lty=1, lwd=2, type="l")
...
plot(t, prod_Iw_Iz[,11], main="Evolution of Iw*Iz after a change in AMU", xlab="time (steps)", ylab="Iw*Iz", ylim=c(0,0.3), lty=1, lwd=2, type="l")
