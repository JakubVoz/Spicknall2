...
plot(time_int, eps_fun1, type="l", lwd=2, col=colforcol[1])
lines(time_int, eps_fun2, lty=1, lwd=2, col=colforcol[2])
lines(time_int, eps_fun3, lty=1, lwd=2, col=colforcol[3])
lines(time_int, eps_fun4, lty=1, lwd=2, col=colforcol[4])
lines(time_int, eps_fun5, lty=1, lwd=2, col=colforcol[5])
...
controltag <- paste(rate[1], "~ equilibrium")
mintag <- paste(rate[2])
