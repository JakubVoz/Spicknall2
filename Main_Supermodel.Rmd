...
```{r param, include=FALSE, cache=TRUE}
...
plot(prhoi, steady_Iw_rho, main="Steady-states : treatment failure variations", xlab="proportion of treated patients", ylab="ratio", ylim=c(0,1), lty=3, lwd=2, type="l")
...
plot(pc_zwi, steady_Iw_c_zw, main="Steady-states : replacement of Iz by Iw rate variations", xlab="rate of successful replacement of Iw by Iz in untreated patients", ylab="ratio", ylim=c(0,1), lty=3, lwd=2, type="l")
