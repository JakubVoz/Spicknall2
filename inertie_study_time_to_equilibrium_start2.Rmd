...
plot(pepsi_change, time_down, main="Inertia - delta epsilon = 0.01", xlab=expression(epsilon), ylab="time to stabilization", lwd=2, col='blue', type='l', xlim=c(0,0.20))
...
plot(pepsi_change, time_down, main="Inertia", xlab=expression(epsilon), ylab="time to stabilization", lwd=2, col='blue', type='l', xlim=c(0,0.17))
lines(pepsi_change, time_up, lwd=2, col='red', type='l')
