---
title: "inertie_study_time_to_equilibrium_start2"
author: "Jakub"
date: "6 ledna 2017"
...
plot(pepsi_change, time_down, main="Inertia - delta epsilon = 0.01", xlab="proportion of treated patients", ylab="time to stabilization", lwd=2, col='blue', type='l', xlim=c(0,0.20))
lines(pepsi_change, time_up, lwd=2, col='red', type='l')
...
plot(pepsi_change, time_down, main="Inertia", xlab="proportion of treated patients", ylab="time to stabilization", lwd=2, col='blue', type='l', xlim=c(0,0.17))
lines(pepsi_change, time_up, lwd=2, col='red', type='l')
...
plot(epsx1, diff_1, main="Inertia : difference between decreasing \n and increasing epsilon", xlab="proportion of treated patients", ylab="delta t", lwd=2, col='red', type='l', xlim=c(0,0.17))
...
plot(epsx2, diff_2_same_metrics, main="Inertia : comparison of differences between decreasing \n and increasing epsilon", xlab="proportion of treated patients", ylab="delta t/ delta eps", lwd=2, col='blue', type='l', xlim=c(0,0.17))
