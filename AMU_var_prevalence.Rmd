...
```{r steady_state_QA, echo=FALSE, fig.align='center', cache=TRUE, warning = FALSE}

Iz_ss <- Iz[nrow(Iz),]
Iw_ss <- Iw[nrow(Iw),]
QA_ss_Iw <- Iw_ss*epsvar
QA_ss_Iw_Iz <- (Iw_ss+Iz_ss)*epsvar

QA_ss_Iw <- as.matrix(QA_ss_Iw)
QA_ss_Iw_Iz <- as.matrix(QA_ss_Iw_Iz)

plot(QA_ss_Iw, p_steady, main="Evolution of p ratio - prevalence, Iw treated", xlab="QA", ylab="p", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)


plot(QA_ss_Iw_Iz, p_steady, main="Evolution of p ratio - prevalence, all treated", xlab="QA", ylab="p", ylim=c(0,1), lwd=2, col='red', lty=1, type = 'l')

#burden of infection

burd <- Iw_ss+Iz_ss

plot(QA_ss_Iw, burd, main="Evolution of burden of infection - Iw treated", xlab="QA", ylab="Burden of Infection", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)

plot(QA_ss_Iw_Iz, burd, main="Evolution of burden of infection - all treated", xlab="QA", ylab="Burden of Infection", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)

#QA as fn of PTP

plot(epsvar, QA_ss_Iw, main="Evolution of QA, Iw treated", xlab="PTP", ylab="QA", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')

plot(epsvar, QA_ss_Iw_Iz, main="Evolution of QA, all treated", xlab="PTP", ylab="QA", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')
