...
plot(epsvar, QA_ss_Iw, main="Evolution of QA, Iw treated", xlab=expression(epsilon), ylab="QA", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')

plot(epsvar, QA_ss_Iw_Iz, main="Evolution of QA, all treated", xlab=expression(epsilon), ylab="QA", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')
