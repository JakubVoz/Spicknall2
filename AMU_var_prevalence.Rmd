...
plot(AMU_ss_Iw, p_steady, main="Evolution of p ratio - prevalence, Iw treated", xlab="AMU", ylab="p", ylim=c(0,1), col='red', type = 'l', lty=1)


plot(AMU_ss_Iw_Iz, p_steady, main="Evolution of p ratio - prevalence, all treated", xlab="AMU", ylab="p", ylim=c(0,1), lwd=2, col='red', lty=2, type = 'l')
