...
#plotting S
plot(t, S[,11], main="Evolution of Susceptible population after a variation of  PTP", xlab="time (steps)", ylab="S ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, S_der[,11], main="Derivative of Susceptible population after a variation of  PTP", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(t3, S_der_zoom[,11], main="Derivative of Susceptible population after a variation of  PTP", xlab="time (steps)", ylab="S ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
#plotting Iw
plot(t, Iw[,11], main="Evolution of population infected with sensitive strain after a variation of  PTP", xlab="time (steps)", ylab="Iw ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Iw_der[,11], main="Derivative of population infected with sensitive strain after a variation of  PTP", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(t3, Iw_der_zoom[,11], main="Derivative of population infected with sensitive strain after a variation of  PTP", xlab="time (steps)", ylab="Iw ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
#plotting Iz
plot(t, Iz[,11], main="Evolution of population infected with resistant strain after a variation of  PTP", xlab="time (steps)", ylab="Iz ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Iz_der[,11], main="Derivative of population infected with resistant strain after a variation of  PTP", xlab="time (steps)", ylab="Iz ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
#plotting zoomed Iw derivative with respect to time
plot(t3, Iz_der_zoom[,11], main="Derivative of population infected with resistant strain after a variation of  PTP", xlab="time (steps)", ylab="Iz ratio derivative", ylim=c(-0.005,0.005), lty=1, lwd=2, type="l")
...
plot(epsvar, p_steady, main="Evolution of p ratio - prevalence", xlab="PTP", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t, prod_S_Iw[,11], main="Evolution of S*Iw after a change in PTP", xlab="time (steps)", ylab="S*Iw", ylim=c(0,0.3), lty=1, lwd=2, type="l")
...
plot(t, prod_S_Iz[,11], main="Evolution of S*Iz after a change in PTP", xlab="time (steps)", ylab="S*Iz", ylim=c(0,0.3), lty=1, lwd=2, type="l")
...
plot(t, prod_Iw_Iz[,11], main="Evolution of Iw*Iz after a change in PTP", xlab="time (steps)", ylab="Iw*Iz", ylim=c(0,0.3), lty=1, lwd=2, type="l")
...
```{r steady_state_AMU, echo=FALSE, fig.align='center', cache=TRUE, warning = FALSE}

Iz_ss <- Iz[nrow(Iz),]
Iw_ss <- Iw[nrow(Iw),]
AMU_ss_Iw <- Iw_ss*epsvar
AMU_ss_Iw_Iz <- (Iw_ss+Iz_ss)*epsvar

AMU_ss_Iw <- as.matrix(AMU_ss_Iw)
AMU_ss_Iw_Iz <- as.matrix(AMU_ss_Iw_Iz)

plot(AMU_ss_Iw, p_steady, main="Evolution of p ratio - prevalence, Iw treated", xlab="AMU", ylab="p", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)


plot(AMU_ss_Iw_Iz, p_steady, main="Evolution of p ratio - prevalence, all treated", xlab="AMU", ylab="p", ylim=c(0,1), lwd=2, col='red', lty=1, type = 'l')

#burden of infection

burd <- Iw_ss+Iz_ss

plot(AMU_ss_Iw, burd, main="Evolution of burden of infection - Iw treated", xlab="AMU", ylab="Burden of Infection", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)

plot(AMU_ss_Iw_Iz, burd, main="Evolution of burden of infection - all treated", xlab="AMU", ylab="Burden of Infection", ylim=c(0,1), col='red', type = 'l', lty=1, lwd=2)

#AMU as fn of PTP

plot(epsvar, AMU_ss_Iw, main="Evolution of AMU, Iw treated", xlab="PTP", ylab="AMU", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')

plot(epsvar, AMU_ss_Iw_Iz, main="Evolution of AMU, all treated", xlab="PTP", ylab="AMU", ylim=c(0,0.1), lwd=2, col='red', lty=1, type = 'l')
