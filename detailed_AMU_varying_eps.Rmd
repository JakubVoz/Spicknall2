---
title: "detailed_AMU_varying_eps"
author: "Jakub"
...
plot(doses, prop_treated[,1], main="Proportion of treated patients", xlab="Drug quantity", ylab="eps", ylim=c(0 , eps_max), lwd=2, type="l", col='black')
...
plot(doses, iz_steady[,1], main="Resistant cases at steady states \n while varying c*t", xlab="Drug quantity", ylab="Iz", ylim=c(0,0.40), lwd=2, lty=1, type="l", col='black')
...
plot(prop_treated[,1], iz_steady[,1], main="Resistant cases at steady states \n while varying epsilon", xlab="proportion of treated", ylab="Iz", ylim=c(0,0.40), xlim=c(0,eps_max), lwd=2, type="l", col='black')
...
plot(doses, iw_steady[,1], main="Sensitive cases at steady states \n while varying c*t", xlab="Drug quantity", ylab="Iw", ylim=c(0,0.70), lwd=2, lty=1, type="l", col='black')
...
plot(prop_treated[,1], iw_steady[,1], main="Sensitive cases at steady states \n while varying epsilon", xlab="proportion of treated", ylab="Iw", ylim=c(0,0.70), xlim=c(0,eps_max), lwd=2, type="l", col='black')
