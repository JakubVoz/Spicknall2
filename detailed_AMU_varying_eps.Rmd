...
AMU = c(0.02, 0.04, 0.06, 0.08, 0.10, 0.12)
...
legend("bottomright" , inset=.05, c("Sc. 1", "Sc. 2"), lty=c(1,1), lwd=c(2,2), col=c("black", "red"))
...
plot(doses, prop_treated[,1], main="Proportion of treated patients", xlab="Drug quantity", ylab="eps", ylim=c(0,0.30), lwd=2, type="l", col='black')
...
plot(prop_treated[,1], iz_steady[,1], main="Resistant cases at steady states \n while varying epsilon", xlab="proportion of treated", ylab="Iz", ylim=c(0,0.40), xlim=c(0,0.30), lwd=2, type="l", col='black')
...
plot(prop_treated[,1], newcase[,1], main="Global incidence while varying epsilon", xlab="proportion of treated", ylab="Incidence", ylim=c(0,0.01), xlim=c(0,0.3), lwd=2, type="l", col='black')
