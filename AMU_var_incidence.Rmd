...
state <- c(S=1-2*prop, Iw=prop, Iz=prop, dnewcasesIz=0, dnewcasesIw=0, dsecondaryres=0, dprimaryres=0, S_to_Iw=0, Iz_to_Iw=0, Iw_to_S=0, Iw_to_Iz=0)
...
SIS=function(times, state, parameters){
  with(as.list(c(state,parameters)),
       { dnewcasesIz=beta_z*Iz*S + eps*beta_z*Iz*Iw + rho*eps*Iw
        ...
        dS_to_Iw = beta_w*Iw*S
        dIz_to_Iw = eps*beta_z*Iz*Iw
        dIw_to_S = gamma*(1-eps)*Iw + gamma_prim*eps*Iw
        dIw_to_Iz = eps*beta_z*Iz*Iw + rho*eps*Iw
        
        list(c(dS, dIw, dIz, dnewcasesIz, dnewcasesIw, dsecondaryres, dprimaryres, dS_to_Iw, dIz_to_Iw, dIw_to_S, dIw_to_Iz))
       })
}
...
state3 <- c(S=out_init$S[a+1], Iw=out_init$Iw[a+1], Iz=out_init$Iz[a+1], Iwz=out_init$Iwz[a+1], dnewcasesIz=0, dnewcasesIw=0, dsecondaryres=0, dprimaryres=0, S_to_Iw=0, Iz_to_Iw=0, Iw_to_S=0, Iw_to_Iz=0)
...
nnewiz <- seq(5,ncol(out), by=12)
nnewiw <- seq(6,ncol(out), by=12)
nnewsec <- seq(7,ncol(out), by=12)
nnewprim <- seq(8,ncol(out), by=12)

nS_to_Iw <- seq(8,ncol(out), by=12)
nIz_to_Iw <- seq(9,ncol(out), by=12)
nIw_to_S <- seq(10,ncol(out), by=12)
nIw_to_Iz <- seq(11,ncol(out), by=12)
...
plot(t2, NewS_to_Iw[,11], main="Flow : infection of susceptibles \n after a change in AMU", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, S_to_Iw_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of \n resistant cases after a change in AMU", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_to_Iw_ss, xlab="AMU", ylab="Iz to Iw flow", main = "Impact of AMU on steady state Iz to Iw flow", type="l")
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive \n cases after a change in AMU", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.0002), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_S_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.0002), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iw_to_S_ss, xlab="AMU", ylab="Iw to S flow", main = "Impact of AMU on steady state Iw to S flow", type="l")
...
plot(time_zoom, Iw_to_Iz_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(epsvar, Iw_to_Iz_ss, xlab="AMU", ylab="Iw to Iz flow", main = "Comparing strength and evolution \n of different flows related to Iw", type="l", lty=2, col="red", lwd=2)

lines(epsvar, Iw_to_S_ss, lty=1, col="red", lwd=2)
lines(epsvar, Iz_to_Iw_ss, lty=2, col="green", lwd=2)
lines(epsvar, S_to_Iw_ss, lty=1, col="green", lwd=2)
...
plot(epsvar, Iwz_ss, xlab="AMU", ylab="Incidence", main = "Burden of infection", type="l", col="brown", lwd=2, ylim=c(0,0.013))
