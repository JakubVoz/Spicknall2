...
plot(t2, NewIz[,11], main="Incidence of resitant infections after a change in AMU", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_zoom[,11], main="Incidence of resitant infections after a change in AMU : dynamics", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, NewIw[,11], main="Incidence of susceptible infections after a change in AMU", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_zoom[,11], main="Incidence of sensitive infections after a change in AMU : dynamics", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance after a change in AMU", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,11], main="Incidence of primary resistence after a change in AMU : dynamics", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance after a change in AMU", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,11], main="Incidence of secondary resistence after a change in AMU : dynamics", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, p_zoom[,11], main="Estimated p after a change in AMU : dynamics", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
