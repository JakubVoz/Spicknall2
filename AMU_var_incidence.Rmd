...
plot(t2, Newp[,11], main="Estimated p after a change in PTP", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Realp[,11], main="Estimated real p after a change in PTP", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive \n cases after a change in PTP", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,11], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iz to S", ylim=c(0, 0.001), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,11], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.002,0.003), lty=1, lwd=2, type="l")
...
```{r AMU_as_func_t_and_vareps, echo=FALSE, fig.align='center'}
...
for (i in 1:length(pepsi)) {
  AMU_Iw[,i] <- AMU_Iw[,i]*pepsi[i]
}

AMU_Iw_Iz <- Iw + Iz

for (i in 1:length(pepsi)) {
  AMU_Iw_Iz[,i] <- AMU_Iw_Iz[,i]*pepsi[i]
}
...
AMU_Iw_zoom <- vrai_Iw_zoom

for (i in 1:length(pepsi)) {
  AMU_Iw_zoom[,i] <- AMU_Iw_zoom[,i]*pepsi[i]
}

AMU_Iw_Iz_zoom <- vrai_Iw_zoom + vrai_Iz_zoom

for (i in 1:length(pepsi)) {
  AMU_Iw_Iz_zoom[,i] <- AMU_Iw_Iz_zoom[,i]*pepsi[i]
}



plot(t2, AMU_Iw[,11], main="AMU in time, Iw treated", xlab="time (steps)", ylab="AMU", ylim=c(0,0.1), lty=1, lwd=2, type="l")

capture.output(apply(AMU_Iw, 2, linfun, t2), file='NUL')

legend("topleft" , inset=.05, c("PTP=0.20", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))


plot(t2, AMU_Iw_Iz[,11], main="AMU in time, all treated", xlab="time (steps)", ylab="AMU", ylim=c(0,0.1), lty=1, lwd=2, type="l")

capture.output(apply(AMU_Iw_Iz, 2, linfun, t2), file='NUL')
...
#zoom plot
plot(time_zoom, AMU_Iw_zoom[,11], main="AMU in time, Iw treated", xlab="time (steps)", ylab="AMU", ylim=c(0,0.1), lty=1, lwd=2, type="l")

capture.output(apply(AMU_Iw_zoom, 2, linfun, time_zoom), file='NUL')

legend("topleft" , inset=.05, c("PTP=0.20", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))


plot(time_zoom, AMU_Iw_Iz_zoom[,11], main="AMU in time, all treated", xlab="time (steps)", ylab="AMU", ylim=c(0,0.1), lty=1, lwd=2, type="l")

capture.output(apply(AMU_Iw_Iz_zoom, 2, linfun, time_zoom), file='NUL')
...
```{r p_incid_as_func_AMU_ss, echo=FALSE, fig.align='center'}

AMU_var_ss <- burden*epsvar

AMU_var_ss <- data.matrix(AMU_var_ss)
realp_ss <- data.matrix(realp_ss)

plot(AMU_var_ss, realp_ss, main="P incidence, all treated", xlab="AMU", ylab="real p", ylim=c(0,1), lty=1, lwd=2, type="l")
