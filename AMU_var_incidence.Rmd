...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of \n resistant cases after a change in AMU", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.0001), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iz_to_Iw_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.0001), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, Iz_to_Iw_ss, xlab="AMU", ylab="Iz to Iw flow", main = "Impact of AMU on steady state Iz to Iw flow", ylim=c(0,0.0001), type="l")
...
plot(t2, NewIw_to_Iz[,11], main="Flow : gaining resistance in sensitive \n cases after a change in AMU", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(epsvar, recov_ss, xlab="AMU", ylab="Recovery and incidence at steady state", main = "Comparing strength and evolution \n of different flows related to Infection", type="l", lty=1, col="green", lwd=2, ylim=c(0, 0.01))
...
legend("topright", inset=.05, c("Incidence", "S to Iz", "S to Iw", "Recovery", "Iz to S", "Iw to S" ), lty=c(1,2,3,1,2,3), lwd=rep(2,6), col=c(rep("red",3), rep("green",3)))
