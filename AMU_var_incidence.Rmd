...
plot(t2, Q_Iw[,11], main="Q in time, Iw treated", xlab="time (steps)", ylab="Q", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(t2, Q_Iw_Iz[,11], main="Q in time, all treated", xlab="time (steps)", ylab="Q", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
#zoom plot
plot(time_zoom, Q_Iw_zoom[,11], main="Q in time, Iw treated", xlab="time (steps)", ylab="Q", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(time_zoom, Q_Iw_Iz_zoom[,11], main="Q in time, all treated", xlab="time (steps)", ylab="Q", ylim=c(0,0.1), lty=1, lwd=2, type="l")
...
plot(Q_var_ss, realp_ss, main="I ratio, all treated", xlab="Q", ylab="I ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
