...
```{r plot_multi_var, echo=FALSE, fig.align='center', cache=TRUE}
...
plot(t, Iw[,11], main="Evolution of population infected with sensitive strain after a variation of  ATB usage", xlab="time (steps)", ylab="S ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t, Iz[,11], main="Evolution of population infected with resistant strain after a variation of  ATB usage", xlab="time (steps)", ylab="S ratio", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t, Ratio[,11], main="Evolution of Iz/(Iz+Iw)", xlab="time (steps)", ylab="S ratio", ylim=c(0,2), lty=1, lwd=2, type="l")
