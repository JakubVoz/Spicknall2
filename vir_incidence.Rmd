...
plot(time_zoom, virulence_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, viru_ss, xlab=expression(epsilon), ylab="Iw incidence", main = "Impact of epsilon on steady state Iw incidence", type="l")
```
