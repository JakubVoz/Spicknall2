...
plot(t2, Newsec[,11], main="Incidence of secondary resistance \n after a change in epsilon", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, p_ss, xlab=expression(epsilon), ylab="p", main = "Impact of epsilon on steady state p", type="l", ylim=c(0,1))
```
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive \n cases after a change in epsilon", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.02), lty=1, lwd=2, type="l")
