...
legend("bottomleft" , inset=.05, c("PTP=0.50", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))
...
legend("topleft" , inset=.05, c("PTP=0.50", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance \n after a change in PTP", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")

capture.output(apply(Newsec, 2, linfun, t2), file='NUL')

legend("topright" , inset=.05, c("PTP=0.50", "PTP=0"), lty=c(1,1), lwd=c(2,2), col=c("red", "blue"))

#zoom

plot(time_zoom, sec_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, p_ss, xlab="PTP", ylab="p", main = "Impact of PTP on steady state p", type="l", ylim=c(0,1))
```
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive \n cases after a change in PTP", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.02), lty=1, lwd=2, type="l")
...
plot(time_zoom, Iw_to_S_zoom[,11], main="Dynamics", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.02), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,11], main="Global incidence : zoom", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,11], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iz to S", ylim=c(0, 0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,11], main="Net flow : S to Iz", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.002,0.01), lty=1, lwd=2, type="l")
