...
steady_AMU_Iw_eps <- steady_Iw_eps*pepsi
steady_AMU_Iw_Iz_eps <- (steady_Iw_eps+steady_Iz_eps)*pepsi
...
lines(pepsi, steady_Iz_eps, lty=2, lwd=2)
lines(pepsi, steady_S_eps, lty=1, lwd=2)
lines(pepsi, steady_AMU_Iw_eps, lty=1, lwd=2, col='red')
lines(pepsi, steady_AMU_Iw_Iz_eps, lty=2, lwd=2, col='red')

legend("topright" , inset=.05, c("Iw Sensitive strain", "Iz Resistant strain", "S Susceptible population", 'AMU : Iw treated', 'AMU : all treated' ), lty=c(3,2,1,1,2), lwd=c(2,2,2,2,2), col=c(rep('black',3), rep('red',2)))

```

```{r steady_state_AMU_plot, echo=FALSE, fig.align='center'}

plot(pepsi, steady_AMU_Iw_eps, main="AMU : treatment variations", xlab="PTP", ylab="AMU", ylim=c(0,0.4), lty=1, lwd=2, type="l", col='red')


lines(pepsi, steady_AMU_Iw_Iz_eps, lty=2, lwd=2, col='red')

legend("topright" , inset=.05, c('AMU : Iw treated', 'AMU : all treated' ), lty=c(1,2), lwd=c(2,2), col=c(rep('red',2)))
