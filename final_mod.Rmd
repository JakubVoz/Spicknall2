...
```{r average_stay_within_I, echo=FALSE, fig.align='center'}
epsico <- seq(0, 0.18, by=0.01)
epsico_ext <- seq(0, 1, by=0.01)
...
D_I <- (steady_Iz_eps*(1/pgammaa)+steady_Iw_eps*average_Iw_ext)/(steady_Iz_eps+steady_Iw_eps)

plot(epsico_ext, D_I, main="Average duration of infection", xlab=expression(epsilon), ylab="time (steps)", lty=1, lwd=2, type="l", col="green", ylim=c(0,100))


BOI <- (steady_Iz_eps+steady_Iw_eps)

plot(epsico_ext, BOI, main="Infected population", xlab=expression(epsilon), ylab="ratio", lty=1, lwd=2, type="l", col="green", ylim=c(0,1))


D_T <- (steady_Iz_eps*(1/pgammaa)+steady_Iw_eps*average_Iw_ext)

plot(epsico_ext, D_T, main="Total duration", xlab=expression(epsilon), ylab="time (steps)", lty=1, lwd=2, type="l", col="green")
```
...
plot(epsico_ext, fatality, main="Fatality", xlab=expression(epsilon), ylab="fatality, ratio", lty=1, lwd=2, type="l", col="green")

```


```{r plot_showing_default_val, echo=FALSE, fig.align='center'}

plot(pepsi, steady_Iw_eps, main="Steady-states : treatment variations", xlab=expression(epsilon), ylab="ratio", ylim=c(0,1), lty=3, lwd=2, type="l")

lines(pepsi, steady_Iz_eps, lty=2, lwd=2)
lines(pepsi, steady_S_eps, lty=1, lwd=2)
abline(v=0.10, col='green')
