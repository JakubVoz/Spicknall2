...
legend("topright" , inset=.05, c("Iw Sensitive strain", "Iz Resistant strain", "S Susceptible population", 'QA : Iw treated', 'QA : all treated' ), lty=c(3,2,1,1,2), lwd=c(2,2,2,2,2), col=c(rep('black',3), rep('red',2)))
