---
title: "model_no_competition_inc_no_intrahost"
author: "Jakub"
date: "11 ledna 2017"
...
zoom_area <- 2000 #time span after breakpoint - actually detailed zone rather that zoom
...
pbeta_z2 <- 0.015 #transmission parameter of Iz : intrahost
...
parameters <- c(beta_w=pbeta_w, beta_z=pbeta_z, gamma=pgammaa, gamma_prim=pgamma_tilt, eps=peps, rho=prho, beta_z2=pbeta_z2)
...
SIS=function(times, state, parameters){
  with(as.list(c(state,parameters)),
       { dnewcasesIz=beta_z*Iz*S + eps*beta_z2*Iz*Iw + rho*eps*Iw
         dnewcasesIw=beta_w*Iw*S + (1-eps)*beta_w*Iw*Iz
         dsecondaryres=rho*eps*Iw
         dprimaryres=beta_z*Iz*S + eps*beta_z2*Iz*Iw
         dS = - beta_w*Iw*S - beta_z*Iz*S + gamma*(1-eps)*Iw + gamma_prim*eps*Iw + gamma*Iz
        dIw = beta_w*Iw*S + (1-eps)*beta_w*Iw*Iz - eps*beta_z2*Iz*Iw - rho*eps*Iw - gamma*(1-eps)*Iw - gamma_prim*eps*Iw
        dIz = beta_z*Iz*S + eps*beta_z2*Iz*Iw + rho*eps*Iw - (1-eps)*beta_w*Iw*Iz - gamma*Iz
        dnewS_to_Iw = beta_w*Iw*S
        dIz_to_Iw = (1-eps)*beta_w*Iw*Iz
        dIw_to_S = gamma*(1-eps)*Iw + gamma_prim*eps*Iw
        dIz_to_S = gamma*Iz
        dIw_to_Iz = eps*beta_z2*Iz*Iw + rho*eps*Iw
...
parameters3 <- c(beta_w=pbeta_w, beta_z=pbeta_z, gamma=pgammaa, gamma_prim=pgamma_tilt, eps=peps, rho=prho, beta_z2=pbeta_z2)
...
plot(t2, NewIw[,11], main="Incidence of susceptible infections after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Incidence Iw", ylim=c(0,0.011), lty=1, lwd=2, type="l")
...
plot(t2, NewIz[,11], main="Incidence of resitant infections after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Incidence Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, Newprim[,11], main="Incidence of primary resistance after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="new primary Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, prim_zoom[,11], main="Dynamics \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Incidence primary resistace", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, Newsec[,11], main="Incidence of secondary resistance after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="new secondary Iz", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(time_zoom, sec_zoom[,11], main="Dynamics \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Incidence secondary resistace", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, Newp[,11], main="Estimated p after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
plot(t2, Realp[,11], main="Estimated real p after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Real p", ylim=c(0,1), lty=1, lwd=2, type="l")
...
par(mfrow=c(1,1))
plot(epsvar, realp_ss, xlab=expression(epsilon), ylab="real p", main = "Evolution of p ratio- incidence \n no interhost competition but intrahost is kept (transmission)", type="l", lwd=2)
```

```{r S_to_Iw_flow, echo=FALSE, fig.align='center'}
par(mfrow=c(1,2))

plot(t2, NewS_to_Iw[,11], main="Flow : infection of susceptibles after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="S to Iw", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewS_to_Iz[,11], main="Flow : infection of susceptibles after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="S to Iz", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewIz_to_Iw[,11], main="Flow : infection and conversion of resistant cases after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iz to Iw flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_S[,11], main="Flow : clearance of sensitive cases after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw to S flow", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(t2, NewIw_to_Iz[,11], main="Flow : gaining resistance in sensitive cases after a change in epsilon \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw to Iz flow", ylim=c(0,0.005), lty=1, lwd=2, type="l")
...
plot(epsvar, Iwz_ss, xlab=expression(epsilon), ylab="Proportion flow", main = "Incidence \n no interhost competition but intrahost is kept (transmission)", type="l", col="red", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, Clear, xlab=expression(epsilon), ylab="Proportion flow", main = "Clearance \n no interhost competition but intrahost is kept (transmission)", type="l", col="green", lwd=2, ylim=c(0,0.012))
...
plot(epsvar, S_var_ss, xlab=expression(epsilon), ylab="ratio", main = "Steady-states : treatment variations \n no interhost competition but intrahost is kept (transmission)", type="l", lty=1, lwd=2, ylim=c(0, 1))
...
plot(t2, new_cases[,11], main="Global incidence : dynamics \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, new_cases_zoom[,11], main="Global incidence : zoom \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw+Iz incidence", ylim=c(0.0,0.01), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_S[,11], main="Net flow : Iw to S \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw to S", ylim=c(-0.004,0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iz_S[,11], main="Net flow : S to Iz \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iz to S", ylim=c(-0.004, 0.004), lty=1, lwd=2, type="l")
...
plot(time_zoom, net_Iw_Iz[,11], main="Net flow : Iw to Iz \n no interhost competition but intrahost is kept (transmission)", xlab="time (steps)", ylab="Iw to Iz", ylim=c(-0.004,0.004), lty=1, lwd=2, type="l")
...
```{r fat_test, echo=FALSE, fig.align='center'}
alpha1 <- 0.1
alpha2 <- 0.01
...
steady_Iz_eps <- Iz_var_ss
steady_Iw_eps <- Iw_var_ss

fatality <- epsico_ext*steady_Iw_eps*alpha2 + (1-epsico_ext)*steady_Iw_eps*alpha1 + steady_Iz_eps*alpha1 

plot(epsico_ext, fatality, main="Fatality \n no interhost competition but intrahost is kept (transmission)", xlab=expression(epsilon), ylab="fatality, ratio", lty=1, lwd=2, type="l", col="green", ylim=c(0,0.1))
