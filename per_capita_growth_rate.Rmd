...
plot(x, gr_sens, main="Sensitive and resistant strain growth rate : Sc.1", xlab="Drug quantity", ylab="Growth rate", ylim=c(-0.2,1), lwd=2, type="l", col='blue')
...
plot(x, gr_sens, main="Sensitive and resistant strain growth rate : Sc.2", xlab="Drug quantity", ylab="Growth rate", ylim=c(-0.2,1), lwd=2, type="l", col='blue')
...
plot(doses, iz_steady, main="Resistant cases at steady states \n while varying c*t", xlab="Drug quantity", ylab="Iz", ylim=c(0,0.30), lwd=2, type="l", col='black')
...
plot(doses, p, main="P while varying c*t", xlab="Drug quantity", ylab="p", ylim=c(0,1), lwd=2, type="l", col='black')
...
plot(doses, burden, main="Burden while varying c*t", xlab="Drug quantity", ylab="burden", ylim=c(0,1), lwd=2, type="l", col='black')
...
plot(doses, newcase, main="Global incidence while varying c*t", xlab="Drug quantity", ylab="Incidence", ylim=c(0,0.01), lwd=2, type="l", col='black')
