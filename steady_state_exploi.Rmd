...
steady_sup <- do.call(rbind, lapply(pepsi, exploit_param_exc))
steady_sup <- unlist(steady_sup)
...
plot(pepsi, steady_Iw_sup, main="Exclusion model steady states", xlab="proportion of treated patients", ylab="ratio", ylim=c(0,1), lty=3, lwd=2, type="l")

lines(pepsi, steady_Iz_sup, lty=2, lwd=2)
lines(pepsi, steady_S_sup, lty=1, lwd=2)

legend("topright" , inset=.05, c("Iw Sensitive strain", "Iz Resistant strain", "S Susceptible population" ), lty=c(3,2,4,1), lwd=c(2,2,2))
